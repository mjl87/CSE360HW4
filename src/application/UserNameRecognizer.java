...
/**
 * This class checks to see if the username a user inputs is valid, meaning it checks for things like
 * first character is a letter, satisfies minimum character length, and so on.
 */
